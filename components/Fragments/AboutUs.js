...
function AboutUs() {
  return (
    <div className="bg-[#131D40] py-32 px-24 relative">
      ...
      <h1 className="text-5xl font-medium text-[#99D0DA] max-w-4xl leading-[1.2] mt-7">
      ...
      <img
        src="/spark.png"
        className="absolute right-0 -translate-x-[20%] translate-y-[20%] opacity-50 top-0 h-72 w-fit"
        alt=""
      />
    </div>
  );
